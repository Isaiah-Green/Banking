...
class account:
    ...
    def print_acc(self):
        return f"[UserID: {self._User_Id} , Account Number: {self.account_num} , Account Type: {self.accountType} , Balance: {self.balance}]"


'''
Testing
imported_account = "[UserID: 765243897 , Account Number: 3165 , Account Type: Credit , Balance: 854000]"
